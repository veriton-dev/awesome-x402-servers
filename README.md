...
* Veriton HTML→JSON - Metered HTML→structured JSON for agents ($0.02/$0.05 USDC Base, HTTP 402). [Docs](https://veriton-dev.github.io/veriton-micro-dev/api/) [Discovery](https://tue-alabama-married-wonder.trycloudflare.com/.well-known/x402) [Github](https://github.com/veriton-dev/veriton-micro-dev)
